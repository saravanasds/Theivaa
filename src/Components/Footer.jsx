    ...
    <>
      <div className="w-full min-h-auto bg-primary text-white flex flex-col justify-center items-center pt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-20 lg:px-10 md:p-10 lg:py-8 gap-10">
          <div
            className="flex-shrink-0 font-sen tracking-wider px-10"
            data-aos="fade-up"
          ...
          >
            ...
            <p className="py-4 text-sm lg:text-base">
              ...
              Repudiandae veniam perferendis optio accusantium quis repellendus
              quos illum ipsa autem tenetur.
            </p>
            <div className="">
              <IoLogoWhatsapp className="lg:text-5xl text-2xl rounded-full lg:p-2  bg-white text-primary  border-2  border-secondary hover:text-secondary hover:border-primary" />
            </div>
          </div>
          <address
            className="px-10 lg:px-0 text-sm"
            data-aos="fade-up"
            data-aos-duration="800"
            data-aos-delay="400"
          >
            <h2 className="lg:text-2xl text-xl font-semidold mb-8 text-center hover:text-secondary">
              Get in Touch
            </h2>
          ...
          data-aos-duration="800"
          data-aos-delay="500">
            <h2 className="lg:text-2xl text-xl font-semidold lg:mb-5 text-center hover:text-secondary ">
              Quick Links
            </h2>
            <div
