    ...
    <div className=' w-full h-auto'>
      <div className='w-full h-[450px] bg-center bg-cover object-cover hidden lg:block' style={{
        ...
        <h2 className='text-5xl font-bold text-white tracking-wider 'style={{ textShadow: "3px 3px 0px rgba(0,0,0,0.9)" }}data-aos="fade-up"
          ...
          data-aos-delay="300">About Us</h2>
          </div>
     ...
     <div className="w-full h-auto bg-gray-200 text-primary font-semibold lg:text-3xl  text-center tracking-wider lg:px-20 mb-20 lg:py-20 px-10 py-10"data-aos="fade-up"
          data-aos-duration="800"
          data-aos-delay="300">
