    ...
    <>
      <div className="border-b-2 border-primary py-10 lg:px-10 px-5">
        ...
        >
          ...
          <span className="text-darkred font-semibold lg:text-lg tracking-wider">TIA-TEST HUB</span>offers extensive past exam papers for tests like JEE, NEET,TNPSC (All groups), UPSC, SSC, Banking and Olympiads. 
