...
const HomeServices = ({icon,heading,description}) => {
  return (
  <>
  <div className='w-full min-h-[300px]  border-2 border-primary rounded-xl flex flex-col justify-center items-center lg:p-[2rem] px-5 py-5  shadow-lg hover:scale-[1.1] hover:shadow-xl transform transition-all duration-300'>
