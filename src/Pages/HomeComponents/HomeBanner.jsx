    ...
    <>
      ...
      >
        <div className="w-full lg:h-[600px] h-[400px] text-center flex flex-col justify-center lg:items-end items-center  bg-[rgba(0,136,144,0.7)] lg:pr-16   py-10 px-5 lg:py-8 lg:px-3">
          <div
            className="lg:w-1/2 h-[500px] border-2 border-secondary rounded-lg flex flex-col justify-center lg:items-center items-center lg:px-10 lg:py-8 px-5 py-5 shadow-lg"
            data-aos="fade-up"
          ...
          >
            <h2
              className="lg:w-full w-full text-white font-bold lg:text-6xl md:text-5xl text-2xl px-3 lg:px-0 tracking-wider lg:mb-8 mb-2  flex gap-5 md:px-10 leading-normal "
            ...
            <p className="lg:text-lg text-sm tracking-wider text-white text-center mb-5">
              At Shree Theivaa Academy, we partner with industry leaders to
              offer cutting-edge educational experiences, integrating their
