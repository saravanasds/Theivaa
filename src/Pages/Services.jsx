      ...
      <div className="lg:w-full lg:h-auto px-8 pb-8 pt-8 lg:px-20 lg:pb-20 lg:pt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 object-cover">
        ...
        />
         <ServiceFlip
          ...
          backContent="AISECT UNIVERSITY"
          backContent2="Skill knowledge provider Information Technology and IT-Enabled-Services courses."
          backColor="bg-yellow-500"
        ...
        />
          ...
          backContent="Gurcharanam Acadamy - Kota Rajashthan"
        ...
        />
         <ServiceFlip
          frontContent="CWEECE"
          backContent="CWEECE"
          backContent2="Centre for Women Empowernment & Early Childhood Education."
          backColor="bg-yellow-500"
          backgroundImage={bg3}
          backgroundImageback={paint}
          button="View Details"
        ...
        />
         <ServiceFlip
          ...
          backContent2="Kids after school programs.."
          frontColor="bg-green-500"
          backColor="bg-yellow-500"
