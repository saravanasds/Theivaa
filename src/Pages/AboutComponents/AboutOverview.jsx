...
const AboutOverview = () => {
  return (
    <>
    <div className=' container mx-auto w-full h-auto flex flex-col justify-center items-center lg:pt-10 lg:pb-10 px-8'>
       ...
       <div className='w-full h-auto lg:px-10 px-5 text-white bg-primary lg:py-10 py-5 lg:gap-10'>
